...
public class ListarCD extends javax.swing.JPanel {
    ...
    public static void main(String args[]) {
        ...
        /*try {
            ...
            java.util.logging.Logger.getLogger(ListarCD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
